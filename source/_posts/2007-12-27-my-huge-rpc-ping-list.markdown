---
comments: true
date: 2007-12-27 13:29:51
updated: 2018-03-28 12:22
layout: post
title: My Huge RPC Ping list
categories:
- Programming

permalink: /blog/programming/my-huge-rpc-ping-list/
Author: Jeremy Morgan

---

I ping a lot of RPC Services when I post. If you dont know what an RPC ping is, [read here](http://www.xmlrpc.com/). This is a good way to let these services know you've updated. While it may not be necessary to use all these sites, it doesn't hurt to have them. Here is a list of 254 services good at the time of this writing.
...
If you're running WordPress, you can just dump them in the software. Go to **options->writing** and scroll down to "**update services**" and paste them in.
